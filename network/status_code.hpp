...
inline const std::map<StatusCode, std::string>& status_code_strings()
{
    static const std::map<StatusCode, std::string> status_code_strings = {
        ...
        { StatusCode::information_switching_protocols,
        ...
        { StatusCode::redirection_temporary_redirect,
          "307 Temporary Redirect" },
        { StatusCode::redirection_permanent_redirect,
        ...
        { StatusCode::client_error_method_not_allowed,
        ...
        { StatusCode::client_error_precondition_failed,
        ...
        { StatusCode::client_error_expectation_failed,
        ...
        { StatusCode::server_error_service_unavailable,
...
inline StatusCode status_code(const std::string& status_code_string) noexcept
{
    ...
    if (number[0] < '0' || number[0] > '9' || number[1] < '0' ||
        number[1] > '9' || number[2] < '0' || number[2] > '9')
        return StatusCode::unknown;

    class StringToStatusCode
      : public std::unordered_map<std::string, SimpleWeb::StatusCode>
    {
    public:
        StringToStatusCode()
        {
